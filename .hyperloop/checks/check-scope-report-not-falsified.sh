...
#
# Restored: was removed in 687e4576 as "redundant" but pre-submit.sh on task
# branches continued to reference it, causing spurious "No such file" FAILs.
# Recreated to eliminate the broken dependency.
