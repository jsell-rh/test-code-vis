...
have been added to main since the last attempt, confirming that Sync Point 1 is
necessary and functioning correctly.)
...
The branch contains zero commits above origin/main.
...
authority. This is the 8th consecutive attempt with the same FAIL outcome.
