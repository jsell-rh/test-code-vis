...
- Sync Point 1: `git fetch origin main` + sync `.hyperloop/checks/` from origin/main
- Resolved stale `check-pass-report-no-raw-fail-lines.sh` (content differed from main)
